...
class PropertyPublishedManager(models.Manager):
    def get_queryset(self):
        queryset = super(PropertyPublishedManager, self).get_queryset().filter(published_status=True)
        return queryset
...
class Property(TimeStampedUUIDModel):
    ...
    ref_code = models.CharField(
        verbose_name=_("Property reference code"), max_length=255,
    ...
    postal_code = models.CharField(verbose_name=_("Postal Code"),max_length=100,
                                   default="127006")
    ...
    plot_area = models.DecimalField(verbose_name=_("Plot Area(m^2)"),
                                    ...
                                    default=0.0)
    total_floors = models.IntegerField(verbose_name=_("Numbers of floors"),
                                       default=0)
    ...
    photo1 = models.ImageField(default="/interior_sample.jpg",
                                    null=True, blank=True)
    photo2 = models.ImageField(default="/interior_sample.jpg",
                                    null=True, blank=True)
    photo3 = models.ImageField(default="/interior_sample.jpg",
                                    null=True, blank=True)
    photo4 = models.ImageField(default="/interior_sample.jpg",
                                    null=True, blank=True)
    ...
    def final_property_price(self):
        ...
        price_after_price = float(round(property_price + tax_amount,2))
